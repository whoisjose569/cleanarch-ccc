...
class PaidBillsRepositorySpy():
    def __init__(self) -> None:
        self.__insert_paid_bills_attributes = {}
        self.__select_paid_bills_attributes = {}

    def insert_paid_bills(self, family_id: int, type: str, value: float, payment_date: str) -> None:
        self.__insert_paid_bills_attributes["family_id"] = family_id
        self.__insert_paid_bills_attributes["value"] = value
        self.__insert_paid_bills_attributes["payment_date"] = payment_date
